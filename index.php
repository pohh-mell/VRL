    ...
    <div class="container">
        <div class="middle">    
            <div class="row">
                ...
                <div class="col-xs-8 col-md-4 col-md-offset-1">
                    <a href="http://e-haaletus.azurewebsites.net/kandideerimine.php" id="kandideerimine" class="wide blue"><img src="picid/kandideeri-oige1.png" alt="kandideeri" class="pilt">KANDIDEERI</a>
                </div>
                <?php endif ?>
            </div>
        </div>
